...
void Test08()
{
  ...
  exec("SELECT BNLJOIN employee, ages WHERE Age = Age RECORDS(10)");

  exec("SELECT BNLJOIN (BNLJOIN employee, salary WHERE Salary = Salary RECORDS(10)), ages WHERE Age = Age RECORDS(10)");

  exec("SELECT BNLJOIN (BNLJOIN (BNLJOIN employee, employee WHERE EmpName = EmpName RECORDS(10)), salary) WHERE Salary = Salary RECORDS(10)), ages WHERE Age = Age RECORDS(10)");
